...
var I=new XRegExp(r+"((?:(?!</span>).)*)"+s,"gi"),H=3;if(!p(XRegExp))throw Error("Trouveur - This library requires XRegExp to work");if(E)p=i.createElement("style"),p.innerHTML=".trouveur-highlight {background: yellow; color: black;}",E.appendChild(p);var f=function(){};f.version="0.9";f.count=function(a,c,b){var e=0;v(a,c);b=h(b);b.r=l;c=x(a,c,b);if(c!==null&&c.length>0)a=u(a,c,b),e=a.matchCount;return e};f.find=function(a,c,b){v(a,c);var b=h(b),e=x(a,c,b),c=[];if(e!==null&&e.length>0){if(!b.i||
